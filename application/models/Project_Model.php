...
class Project_Model extends CI_Model {
	...
	public function dt_project_non_serverside($keyword = '')
	{
		$search = $this->db->escape_str($keyword);
		$username = $this->session->userdata('username');
		$id_menu = 3;
		...
		$kolom_search = ['id', 'type', 'brand', 'kontrak', 'item', 'style', 'no_pattern', '`order`', 'size', 'qty', 'price', 'format_tec_sheet_plan', 'format_tec_sheet_actual', 'format_pattern_plan', 'format_pattern_actual', 'format_fabric_plan', 'format_fabric_actual', 'format_aksesories_plan', 'format_aksesories_actual', 'due_date', 'tujuan_sample', 'master_code', 'line', 'persiapan_plan', 'persiapan_actual', 'cutting_plan', 'cutting_actual', 'cad_plan', 'cad_actual', 'sewing_plan', 'sewing_actual', 'fg_plan', 'fg_actual', 'kirim_plan', 'kirim_actual', 'keterangan'];
		...
		$view = $this->db->query(" SELECT * FROM ( $sql ) AS tb WHERE 1 = 1 $condition ")->result();
